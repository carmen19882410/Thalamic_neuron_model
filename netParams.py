...
netParams.popParams['import_swc3py'] = {'cellType': 'DET', 'numCells': 1, 'cellModel': 'HH'}
...
netParams.stimSourceParams['pulse'] = {'type': 'IClamp', 'del':200, 'dur':10, 'amp':1} #ms  nA
netParams.stimTargetParams['pulse->TC'] = {'source': 'pulse', 'conds': {'cellType': 'DET'}, 'sec':'soma_0', 'loc':0.5}
